...
export default class EmbedUtil {
    ...
    public static getHelpMenuEmbed(client: Client): MessageEmbed {
        return new MessageEmbed()
            ...
            .setColor("PURPLE")
            .setDescription(`Below you can find all available commands. Elixir has fully adapted to built-in slash 
            commands for version 3.0. If you'd like to use this bot in your own server or would like to add slash 
            commands to your server, [invite it here](${Config.get("INVITE")}).`)
            .addField("Music Commands", "```" +
                "play, shuffle, skip, filter, nowplaying, pause, queue, resume, stop, volume, join, previous" + "```")
